...
b4w.register("ecomask_b4w_main", function(exports, require) {
...
var APP_ASSETS_PATH = m_cfg.get_assets_path("ecomask_b4w");
...
function load() {
    ...
    m_data.load(APP_ASSETS_PATH + "mask_eco2_test.json", load_cb, preloader_cb);
}
...
function preloader_cb(percentage) {
    ...
    var icons_container = document.getElementById("icons_container");
...
b4w.require("ecomask_b4w_main").init();
